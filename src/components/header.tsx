...
function MoonStarIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="me-1" style={{verticalAlign: "-.125em"}} viewBox="0 0 16 16">
...
export default function Header({title, avatar} : HeaderProps) {
    ...
    return (
        <header className="d-flex justify-content-between align-items-center w-100 mb-3 bg-gray">
            ...
            <button className="btn btn-secondary mx-3 my-2" onClick={handleClick}>{icon}{nextTheme}</button>
        </header>
    );
}
